...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi | I'm Abhishek Goud <Image className="w-6" src={assets.hand_icon} alt=""/></h3>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            <a className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent' href="#contact">contact me <Image className='rounded-full w-4' src={assets.right_arrow_white} alt=''/></a>
