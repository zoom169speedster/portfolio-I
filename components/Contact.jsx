...
const Contact = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto' action="">
      ...
      <textarea name="message" id="" className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90' rows='6' placeholder='Enter your message' required></textarea>
      <button className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover' type='submit'>Submit now <Image className='w-4' src={assets.right_arrow_white} alt=''/></button>
